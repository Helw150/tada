...
do
    ...
    do
	MODEL=$HF_ORG/${MODEL_NAME}-${TASK_NAME}-combined-multivalue
	echo $MODEL
	...
	python run_glue_adapterhub.py \
	       ...
	       --task_name $TASK_NAME \
	       --output_dir ./results_full_combined/$MODEL/$TASK_NAME \
	       --overwrite_output_dir \
	       --do_eval \
	       --hub_model_id=$MODEL \
	       --hub_private_repo \
	...
	python run_glue_adapterhub.py \
	       --model_name_or_path $MODEL \
	       --task_name $TASK_NAME \
	       --output_dir ./results_full_combined/$MODEL/${TASK_NAME}_aave \
	       --overwrite_output_dir \
	       --dialect="aave" \
	       --do_eval \
	       --hub_model_id=$MODEL \
